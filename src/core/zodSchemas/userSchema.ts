...
const InvoiceContactGroupSchema = z.object({
  ...
  gender: z.string().nullable().optional(),// since gender is null in your example
  is_archive: z.boolean().optional(),
country: CountrySchema.optional().optional(),
...
export const UserProfileSchema = z.object({
  ...
  discount_ratio: z.number().nullable().optional(),
  roles: z.array(
    z.object({
      id: z.number(),
      title: z.string(),
  ...
  is_vat_valid: z.number().nullable().optional(),
  communication_by_letter: z.boolean().nullable().optional(),
  vat_number: z.string().nullable().optional(),
  tax_number: z.string().nullable().optional(),
  credit_limit: z.string().nullable().optional(),
  eori_number: z.string().nullable().optional(),
  use_gln_indocuments: z.any().nullable().optional(),
  default_shipping_method_id: z.any().nullable().optional(),
  default_payment_terms_id: z.any().nullable().optional(),
  file_id: z.number().nullable().optional(),
  point: z.any().nullable().optional(),
  is_active: z.boolean().optional(),
  _data: z.any().optional(),
  birth_date: z.string().nullable().optional(),
  created_at: z.string().optional(),
  updated_at: z.string().optional(),
  invoice_contact_group_id: z.number().nullable().optional(),
  flag_id: z.any().nullable().optional(),
  dunning_level_id: z.any().nullable().optional(),
  able_to_see_downline: z.any().nullable().optional(),
  old_id: z.any().nullable().optional(),
  sponsor_id: z.any().nullable().optional(),
  old_sponsor_id: z.any().nullable().optional(),
  career_step_id: z.number().nullable().optional(),
  customer_step_id: z.any().nullable().optional(),
  two_factor_enable: z.boolean().nullable().optional(),
